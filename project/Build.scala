...
object Build extends Build {
  ...
  lazy val basePlatformJvm      = baseModule.jvmProject(baseSharedJvm).settings(basePlatformSettings : _*)
  lazy val basePlatformJs       = baseModule.jsProject(baseSharedJs).settings(basePlatformSettings : _*)
  ...
  lazy val packagesPlatformJvm  = packagesModule.jvmProject(basePlatformJvm).dependsOn(basePlatformJvm)
